    ...
    <div style={cardStyle} className="flex flex-col">
      ...
      <div className="flex flex-wrap justify-center gap-8 p-4">
        <div className="p-4">
          ...
          <p>
            <span className="font-semibold">Atomic Mass :</span> {atomicMass}
          </p>
          <p>
            <span className="font-semibold">Atomic Radius :</span>
            {atomicRadius}
          </p>
        </div>
        <div className="p-4">
          ...
          <p>
            <span className="font-semibold">Bonding Type: </span>
            {bondingType}{" "}
          </p>
        </div>
        <div className="p-4">
          <p>
            <span className="font-semibold">Density: </span> {density}{" "}
          </p>
          <p>
      ...
      <div className="flex flex-wrap justify-center gap-8 p-4">
        <div className="p-4">
          ...
          <p>
            <span className="font-semibold">Electronic Configuration: </span>{" "}
            {electronicConfiguration}
          </p>
        </div>
        ...
        <div className="p-4">
          ...
          <p>
            <span className="font-semibold">VanDelWaals Radius: </span>{" "}
            {vanDelWaalsRadius}{" "}
          </p>
          <p>
      ...
      <div className="flex flex-wrap justify-center gap-8 p-4">
        ...
        <div className="p-4">
          <p>
            <span className="font-semibold">Speed Of Sound: </span>{" "}
            {speedOfSound}{" "}
          </p>
          <p>
      ...
      <div className="flex flex-wrap justify-center gap-4 p-6">
        <p>
          ...
          {isotopes.split(",").map((isotope, index) => (
      ...
      <div className="text-center text-md p-6 gap-4">
        <p>
          <span className="font-semibold">Facts: </span>
          {facts ? facts : <h2>Add some facts of your own...</h2>}
        </p>
      </div>
    </div>
  );
